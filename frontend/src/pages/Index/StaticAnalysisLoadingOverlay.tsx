...
type StaticAnalysisLoadingOverlayProps = {
  /** Percentagem Ghidra (0–100) quando disponível; null = barra indeterminada. */
  progress: number | null;
  compact?: boolean;
};

/** Overlay sobre colunas estáticas enquanto a análise estática decorre. */
  ...
  >
    ...
    <div className={compact ? "w-full max-w-[180px]" : "w-full max-w-[220px]"}>
      <div className="mb-1 flex items-center justify-between text-[10px] font-mono text-muted-foreground">
        <span>{progress != null ? "Progresso Ghidra" : "A processar"}</span>
...
/** Envolve um painel estático com opacidade reduzida e overlay de progresso. */
