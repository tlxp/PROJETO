...
def _default_data_dir() -> Path:
    ...
    Ordem:
      ...
      2) %LOCALAPPDATA%\\RatAnalyzer  (Windows)
      3) fallback: <repo>/data (evita falhar em ambientes sem LOCALAPPDATA)
    """
...
# Retenção/arquivo (pode ser controlado por env vars; a UI também pode chamar endpoints)
