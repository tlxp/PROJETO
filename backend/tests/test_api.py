...
# --- Teste: verifica filename malicioso rejeitado ---
...
# --- Teste: verifica filename traversal posix rejeitado ---
...
# --- Teste: verifica extensao nao suportada ---
...
# --- Teste: verifica limite de tamanho 413 ---
...
# --- Teste: verifica submit analysis filename malicioso ---
...
# --- Teste: verifica submit analysis limite de tamanho ---
...
# --- Testes de ApiToken ---
class TestApiToken:
# --- Teste: verifica sem env token nao exige header ---
...
# --- Teste: verifica purge protegido ---
    def test_purge_protegido(self, client, monkeypatch):
        monkeypatch.setenv("RATANALYZER_API_TOKEN", "super-secreto")
        r = client.post("/api/storage/purge")
        assert r.status_code == 401

# --- Teste: verifica analyze exige token quando configurado ---
...
# --- Teste: verifica analyze aceita com token ---
...
# --- Teste: verifica submit analysis exige token ---
