...
// Testes do middleware de autenticação por token.
...
public sealed class AgentTokenMiddlewareTests
{
    ...
    [Fact]
    // --- Validate arranque token com token devolve True ---
    ...
    [Fact]
    // --- Validate arranque token Without token e Without inseguro devolve False ---
    ...
    [Fact]
    // --- Validate arranque token Without token But inseguro Allowed devolve True ---
    ...
    [Fact]
    // --- Verifica se inseguro desenvolvimento modo Reads ambiente Variable ---
    ...
    [Fact]
    // --- Resolve token a partir de ambiente devolve configurado valor ---
